...
3. Download and install [Gurobi 8.1.1](https://packages.gurobi.com/8.1/gurobi8.1.1_linux64.tar.gz):
```bash
...
#### Traffic Engineering
1. `cd pop/traffic_engineering` 
2. Run `conda env create -f environment.yml` 
3. `conda activate traffic_engineering`
4. `pip install -r requirements.txt`
5. Run `./download.sh` to download the traffic matrices used in our experiments.
